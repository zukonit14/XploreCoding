...
public class algo extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            case R.id.item1:
                Intent intent=new Intent(algo.this,about.class);
    ...
    public void algolearn(View algolearn)
    {
        Intent intent=new Intent(algo.this,webview.class);
        intent.putExtra("i","https://www.khanacademy.org/computing/computer-science/algorithms");
        startActivity(intent);
    }
    ...
    {
        Intent intent=new Intent(algo.this,webview.class);
        intent.putExtra("i","https://www.geeksforgeeks.org/algorithms-gq/");
        startActivity(intent);
    }
    public void books(View cide)
    {
        Uri uri= Uri.parse("https://books.goalkicker.com/AlgorithmsBook/");
    ...
    {
        Intent intent=new Intent(algo.this,webview.class);
        intent.putExtra("i","https://www.programiz.com/article/algorithm-programming");
        startActivity(intent);
    }
}
