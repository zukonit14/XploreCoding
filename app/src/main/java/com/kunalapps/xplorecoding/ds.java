...
public class ds extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            case R.id.item1:
                Intent intent=new Intent(ds.this,about.class);
    ...
    public void dslearn(View dslearn)
    {
        Intent intent=new Intent(ds.this,webview.class);
        intent.putExtra("i","https://www.javatpoint.com/data-structure-tutorial");
        startActivity(intent);
    }
    ...
    {
        Uri uri= Uri.parse("http://lib.mdp.ac.id/ebook/Karya%20Umum/Dsa.pdf");
    ...
    {
        Intent intent=new Intent(ds.this,webview.class);
        intent.putExtra("i","https://www.geeksforgeeks.org/data-structure-gq/");
        startActivity(intent);
    }
    public void sample(View cide)
    {
        Intent intent=new Intent(ds.this,webview.class);
        intent.putExtra("i","https://www.geeksforgeeks.org/data-structures/");
        startActivity(intent);
    }
}
