...
public class python extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            case R.id.item1:
                Intent intent=new Intent(python.this,about.class);
    ...
    public void pylearn(View pylearn)
    {
        Intent intent=new Intent(python.this,webview.class);
        intent.putExtra("i","https://www.w3schools.com/python/default.asp");
        startActivity(intent);
    }
    ...
    {
        Intent intent=new Intent(python.this,webview.class);
        intent.putExtra("i","https://www.geeksforgeeks.org/quiz-corner-gq/#Python%20Programming%20Mock%20Tests");
        startActivity(intent);
    }
    public void books(View cide)
    {
        Uri uri= Uri.parse("https://books.goalkicker.com/PythonBook/");
    ...
    {
        Intent intent=new Intent(python.this,webview.class);
        intent.putExtra("i","https://www.programiz.com/python-programming/examples");
        startActivity(intent);
    }
