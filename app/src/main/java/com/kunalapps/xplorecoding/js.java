...
public class js extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            case R.id.item1:
                Intent intent=new Intent(js.this,about.class);
    ...
    public void jslearn(View jslearn)
    {
        Intent intent=new Intent(js.this,webview.class);
        intent.putExtra("i","https://www.w3schools.com/js/default.asp");
        startActivity(intent);
    }
    ...
    {
        Intent intent=new Intent(js.this,webview.class);
        intent.putExtra("i","https://www.w3schools.com/js/js_quiz.asp");
        startActivity(intent);
    }
    public void books(View cide)
    {
        Uri uri= Uri.parse("https://books.goalkicker.com/JavaScriptBook/");
    ...
    {
        Intent intent=new Intent(js.this,webview.class);
        intent.putExtra("i","https://www.w3schools.com/js/js_examples.asp");
        startActivity(intent);
    }
}
