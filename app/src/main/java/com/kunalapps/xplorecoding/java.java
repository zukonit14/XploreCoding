...
public class java extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            case R.id.item1:
                Intent intent=new Intent(java.this,about.class);
    ...
    public void javalearn(View javalearn)
    {
        Intent intent=new Intent(java.this,webview.class);
        intent.putExtra("i","https://www.w3schools.com/java/default.asp");
        startActivity(intent);
    }
    ...
    {
        Intent intent=new Intent(java.this,webview.class);
        intent.putExtra("i","https://www.geeksforgeeks.org/quiz-corner-gq/#Java%20Programming%20Mock%20Tests");
        startActivity(intent);
    }
    public void books(View cide)
    {
        Uri uri= Uri.parse("https://books.goalkicker.com/JavaBook/");
    ...
    {
        Intent intent=new Intent(java.this,webview.class);
        intent.putExtra("i","https://www.programiz.com/java-programming/examples");
        startActivity(intent);
    }
