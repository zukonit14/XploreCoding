...
public class css extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            case R.id.item1:
                Intent intent=new Intent(css.this,about.class);
    ...
    public void csslearn(View csslearn)
    {
        Intent intent=new Intent(css.this,webview.class);
        intent.putExtra("i","https://www.w3schools.com/css/");
        startActivity(intent);
    }
    ...
    {
        Uri uri= Uri.parse("https://books.goalkicker.com/CSSBook/");
    ...
    {
        Intent intent=new Intent(css.this,webview.class);
        intent.putExtra("i","https://www.w3schools.com/css/css_quiz.asp");
        startActivity(intent);
    }
    public void sample(View cide)
    {
        Intent intent=new Intent(css.this,webview.class);
        intent.putExtra("i","https://www.w3schools.com/css/css_examples.asp");
        startActivity(intent);
    }
}
