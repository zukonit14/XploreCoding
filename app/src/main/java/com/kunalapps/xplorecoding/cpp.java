...
public class cpp extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            case R.id.item1:
                Intent intent=new Intent(cpp.this,about.class);
    ...
    public void cpplearn(View cpplearn)
    {
        Intent intent=new Intent(cpp.this,webview.class);
        intent.putExtra("i","https://www.w3schools.in/cplusplus-tutorial/");
        startActivity(intent);
    }
    ...
    {
        Uri uri= Uri.parse("https://books.goalkicker.com/CPlusPlusBook/");
    ...
    {
        Intent intent=new Intent(cpp.this,webview.class);
        intent.putExtra("i","https://www.geeksforgeeks.org/quiz-corner-gq/#C++%20Programming%20Mock%20Tests");
        startActivity(intent);
    }
    public void sample(View cide)
    {
        Intent intent=new Intent(cpp.this,webview.class);
        intent.putExtra("i","https://www.programiz.com/cpp-programming/examples");
        startActivity(intent);
    }
