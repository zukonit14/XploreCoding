...
public class cshar extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cshar);
        Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("C Sharp");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            case R.id.item1:
                Intent intent=new Intent(cshar.this,about.class);
    ...
    public void csharlearn(View csharlearn)
    {
        Intent intent=new Intent(cshar.this,webview.class);
        intent.putExtra("i","https://www.tutorialspoint.com/csharp/");
        startActivity(intent);
    }
    ...
    {Uri uri= Uri.parse("https://books.goalkicker.com/CSharpBook/");
    ...
    {
        Intent intent=new Intent(cshar.this,webview.class);
        intent.putExtra("i","https://www.tutorialspoint.com/csharp/csharp_online_quiz.htm");
        startActivity(intent);
    }
    public void sample(View cide)
    {
        Intent intent=new Intent(cshar.this,webview.class);
        intent.putExtra("i","https://www.programiz.com/csharp-programming/hello-world");
        startActivity(intent);
    }
}
